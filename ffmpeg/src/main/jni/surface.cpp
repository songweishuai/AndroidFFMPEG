 ...
 */JNIEXPORT jint JNICALL Java_com_example_ffmpeg_VideoSurface_setSurface(
 ...
 * Method:    onPause
 * Signature: ()I
 */JNIEXPORT jint JNICALL Java_com_example_ffmpeg_VideoSurface_nativePausePlayer(JNIEnv *,
                                                                                 jobject) {
 ...
 * Method:    onResume
 * Signature: ()I
 */JNIEXPORT jint JNICALL Java_com_example_ffmpeg_VideoSurface_nativeResumePlayer(JNIEnv *,
                                                                                  jobject) {
 ...
 * Method:    onDestroy
 * Signature: ()I
 */JNIEXPORT jint JNICALL Java_com_example_ffmpeg_VideoSurface_nativeStopPlayer(JNIEnv *,
                                                                                jobject) {
